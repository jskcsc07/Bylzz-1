...
import { InventoryheaderComponent } from "./navbar/inventoryheader.component";
interface MenuItem {
  link: string;
  label: string;
  // icon: IconProp;
...
// ];
@Component({
  selector: 'jsk-inventory',
  imports: [
    InventoryheaderComponent],//AsyncPipe, MatCardModule, MatTableModule],
  template: `
    <section>
      <jsk-inventoryheader/>
  </section>
